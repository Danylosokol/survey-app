...
function App() {
  ...
  const getsurvey = async (value) => {
    ...
    setQuestion2(Tasks.data.data[1]['attributes']);
    setQuestion3(Tasks.data.data[2]['attributes']);
  }
      ...
      <div className="main">
        ...
        <div id="surv" className={page0}>
          ...
          <div className="container">
            ...
            <div className="divid1">
              ...
              <select className="input" onChange={(event) => load(event.target.value)}>
        ...
        <div id="surv" className={page1}>
          ...
          <div className="radio_option">
            <input type="radio" value="22" onClick={(event) => setResponse1(question1.a)} name="r" className="radio" />
            <label className="font1">{question1.a}</label>
            <br/><br/>
            <input type="radio" value="22" name="r" className="radio" onClick={(event) => setResponse1(question1.b)} />
            <label className="font1">{question1.b}</label>
            <br/><br/>
            <input type="radio" value="22" name="r" className="radio" onClick={(event) => setResponse1(question1.c)} />
            <label className="font1">{question1.c}</label>
            <br/><br/>
          </div>
        </div>
        ...
        <div id="surv" className={page2} hidden>
          ...
          <div className="radio_option">
            ...
            <br/><br/>
            <input type="radio" value="22" name="r" className="radio" onClick={(event) => setResponse2(question2.c)} />
            <label className="font1">{question2.c}</label>
            <br/><br/>
          </div>
        </div>
